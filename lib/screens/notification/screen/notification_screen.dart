...
class _NotificationScreenState extends ConsumerState<NotificationScreen> {
  ...
  Future<void> getAllNotifications() async {
    await ref.read(notificationsprovider.notifier).getNotifications(limit: 300);
  }
                    ...
                    return SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          if (notify.subject == 'Password Change Notification')
                            SvgPicture.asset(
                              AppImages.lock,
                              width: 24,
                              height: 24,
                          ...
                          if (notify.subject == 'Email Verified Successfully')
                            SvgPicture.asset(
                              AppImages.peopleIcon,
                              width: 24,
                              height: 24,
